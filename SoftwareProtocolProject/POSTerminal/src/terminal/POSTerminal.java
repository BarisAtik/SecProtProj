...
/**
 * Sample terminal for the POSTerminal applet.
 *
...
public class POSTerminal extends JPanel implements ActionListener {
    ...
    static final String TITLE = "POSTerminal";
    ...
    class SimulatedCardThread extends Thread {
        public void run() {
          ...
          try {
    	    ...
    	    CommandAPDU helloWorld_APDU = new CommandAPDU(0, 3, 0, 0);
            System.out.println("Command APDU: " + helloWorld_APDU.toString());
            System.out.println("Raw content of the command: " + toHexString(helloWorld_APDU.getBytes()));

            response = simulator.transmitCommand(hello_APDU);
            System.out.println("Response APDU: " + response.toString());
            System.out.println("Raw content of the response: " + toHexString(response.getBytes()));
